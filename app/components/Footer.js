...
const Footer = () => {
  ...
  {/* Company Section */}
  <div className="space-y-4 w-full md:w-full text-center md:text-left">
    <h3 className="text-2xl font-semibold text-yellow-400">Zahidul Islam</h3>
  ...
  {/* Quick Links */}
  <div className="space-y-4 w-full md:w-1/4 text-center md:text-left">
