  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 px-4">
      ...
      <section className="w-full max-w-5xl p-6 md:p-12">
        <div className="bg-gradient-to-r from-[#0E1628] to-[#380643] dark:bg-gradient-to-r dark:from-[#0f2027] dark:to-[#2c5364] p-8 rounded-2xl shadow-2xl transition-all duration-300 animate__animated animate__fadeInRight">
          <h2 className="text-4xl font-extrabold text-yellow-500 dark:text-yellow-400 text-center mb-6">
            Find Me Here
          </h2>
