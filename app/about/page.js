    ...
    <div className="bg-gradient-to-r from-[#0E1628] to-[#380643] min-h-screen text-white dark:bg-gradient-to-r dark:from-[#0E1628] dark:to-[#380643]">
      ...
      <header className="flex flex-col items-center justify-center px-8 py-24 text-center md:text-left animate__animated animate__fadeIn md:flex-row md:pl-[146px]">
        <div className="flex flex-col items-center md:items-start md:w-1/2 md:pr-0 pr-8">
          ...
          <p className="text-lg md:text-xl text-gray-300 dark:text-gray-200 mt-4 max-w-2xl mx-auto md:mx-0 animate__animated animate__fadeIn animate__delay-1s">
      ...
      <section className="py-16 px-4 md:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 justify-center">
          {/* HTML5 */}
          <div className="flex flex-col items-center bg-gray-700 dark:bg-gray-800 p-6 rounded-lg shadow-xl transform transition-all duration-300 hover:scale-105 hover:shadow-lg animate__animated animate__fadeIn">
      ...
      <section className="py-16 px-4 md:px-8">
        ...
        <div className="flex justify-center gap-8">
          ...
          <a
            ...
            target="_blank"
            className="text-5xl text-gray-400 dark:text-gray-300 transform hover:scale-110 transition duration-300 animate__animated animate__fadeIn animate__delay-3s"
          >
            <FaGithub />
          </a>
          {/* LinkedIn Icon */}
          <a
            ...
            target="_blank"
            className="text-5xl text-blue-500 dark:text-blue-400 transform hover:scale-110 transition duration-300 animate__animated animate__fadeIn animate__delay-3s"
          >
            <FaLinkedin />
          </a>
        </div>
