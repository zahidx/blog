...
import { faHome, faTags, faInfoCircle, faEnvelope, faSun, faMoon, faXmark } from "@fortawesome/free-solid-svg-icons"; // FontAwesome
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 rounded-md text-white hover:bg-purple-700 transition focus:outline-none"
            >
              {isOpen ? (
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-gradient-to-r from-indigo-600 to-purple-800 p-12 rounded-xl shadow-xl transform transition-all duration-700 ease-out scale-100 opacity-100 w-[90%] sm:w-[500px]"
